...
# # Turn off eager execution to make compatible with TF2.0+
# tf.compat.v1.disable_eager_execution()


# # Used to make compatible with TF2.0+
# def loss2(values):      
#     loss_value = tf.reduce_mean(tf.square(values['u0_tf'] - values['u0_pred'])) + \
#                     tf.reduce_mean(tf.square(values['v0_tf'] - values['v0_pred'])) + \
#                     tf.reduce_mean(tf.square(values['u_lb_pred'] - values['u_ub_pred'])) + \
#                     tf.reduce_mean(tf.square(values['v_lb_pred'] - values['v_ub_pred'])) + \
#                     tf.reduce_mean(tf.square(values['u_x_lb_pred'] - values['u_x_ub_pred'])) + \
#                     tf.reduce_mean(tf.square(values['v_x_lb_pred'] - values['v_x_ub_pred'])) + \
#                     tf.reduce_mean(tf.square(values['f_u_pred'])) + \
#                     tf.reduce_mean(tf.square(values['f_v_pred']))
#     return loss_value
...
#         #                                x0={'u0_tf' : self.u0_tf,
#         #                                    'u0_pred' : self.u0_pred,
#         #                                    'v0_tf' : self.v0_tf, 
#         #                                    'v0_pred' : self.v0_pred,
#         #                                    'u_lb_pred' : self.u_lb_pred,
#         #                                    'u_ub_pred' : self.u_ub_pred,
#         #                                    'v_lb_pred' : self.v_lb_pred,
#         #                                    'v_ub_pred' : self.v_ub_pred,
#         #                                    'u_x_lb_pred' : self.u_x_lb_pred,
#         #                                    'u_x_ub_pred' : self.u_x_ub_pred,
#         #                                    'v_x_lb_pred' : self.v_x_lb_pred,
#         #                                    'v_x_ub_pred' : self.v_x_ub_pred,
#         #                                    'f_u_pred' : self.f_u_pred,
#         #                                    'f_v_pred' : self.f_v_pred},
#         #                                method='L-BFGS-B',
#         #                                jac=True,
...
if __name__ == "__main__": 
    ...
    parser.add_argument('--hidden_sizes', type=lambda s: [int(item) for item in s.split(',')], default='100,100,100,100,2', help="String of hidden sizes seperated by a comma, for example: '100,100,100,2'")
